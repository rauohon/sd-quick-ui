...
- [x] Step 6: 워크플로 저장/불러오기 ✅
  - localStorage에 워크플로 저장 (sd-saved-workflows 키)
  - 저장 시 스텝 타입, 오버라이드 설정, 기본 프롬프트 포함
  - 저장된 워크플로 목록 UI (이름 + 불러오기/삭제 버튼)
  - 불러오기 시 스텝, 오버라이드, 프롬프트 복원
  - 삭제 시 확인 다이얼로그
  - 동일 이름 저장 시 덮어쓰기
...
---
Last updated: 2026-01-06 (Step 6 완료 - Workflow UI 개선 완료)
