...
- [x] 7.3 키보드 단축키 구현
  ...
  - Ctrl+I: 마스크 반전
  - 입력 필드에서 B/E/[/] 비활성화
- [x] 7.4 슬롯/북마크/프리셋 연동 (기본 구조에서 완료)
- [x] 7.5 히스토리 통합 (6단계에서 완료)
...
#### 7단계: UI/UX 완성 ✅ (2026-01-05)
- [x] 7.1 툴바 UI (2단계에서 완료)
  - 브러시/지우개 토글
  - 브러시 크기 슬라이더
  - Undo/Redo 버튼
  - 마스크 채우기/지우기/반전 버튼
- [x] 7.2 캔버스 조작 (3단계에서 완료)
  - 줌 인/아웃 (마우스 휠)
  - 패닝 (스페이스바 + 드래그)
  - Fit to screen 버튼
- [x] 7.3 키보드 단축키
  ...
  - E: 지우개 도구
  - [/]: 브러시 크기 감소/증가
  - Ctrl+Z/Y: Undo/Redo (MaskCanvas에서 구현)
  - Ctrl+I: 마스크 반전
- [x] 7.4 슬롯/북마크/프리셋 연동 (기본 구조에서 완료)
